...
public class MySetting {
    public static final String CONFIG_GG_FB = "config_gg_fb";
    ...
    public static void putConfigGgFb(Context context, long value) {
        SharedPreferences preferences = context.getSharedPreferences("SETTINGSWater", Context.MODE_PRIVATE);
    ...
    public static long getConfigGgFb(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("SETTINGSWater", Context.MODE_PRIVATE);
        return preferences.getLong(CONFIG_GG_FB, 70);
    }
